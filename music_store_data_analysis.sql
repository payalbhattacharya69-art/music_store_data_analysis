Q1: who is the senior most employee based on job titles?*/
...
totals. returns both the city name and sum of all invoice totals.*/
select sum(total) as invoice_total, billing_city from invoice
group by billing_city
order by invoice_total desc

/*Q5: who is the best customer? The customer who has spent the most money will be declared the best 
customer. write a query that returns the person who has spent the money most.*/
...
/*Q2: lets invite the artist who have written the most rock music in our dataset. write a query that 
returns the artist name and the total track count of the top rock bands*/
...
/*Q3 return all track names that have a songs longer than the average song length. return the name 
...
--advance
/*Q1: find how much amount spent by each customer on artists? write a query to written customer
